...
while true
	...
	#do curl -s 'https://youtube.googleapis.com/youtube/v3/liveChat/messages?liveChatId=KicKGFVDUjBvTm5ObU5JX0x6N3ROOW5RVDc0QRILQktrSnk0ckVHUkU&part=snippet&key=AIzaSyAccYmBqZ7KVjssFouTcRwxaBGjk5tdwPI' --header "Authorization: Bearer $access_token" --header 'Accept: application/json' --compressed > json.txt
